...
- Note Pin turns the user's request into a directly usable web workflow. The first experience must be the actual web product behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a tiny one-page utility called Note Pin. It should show a title, one text input for a short note, a save icon button, and a small saved status line. Keep it simple, responsive, and fully client-side.
...
- Record Operations - Note Pin
- Record Editor - Note Pin
- Insights - Note Pin

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Record Operations - Note Pin
...
SCREEN_SPEC_2:
- exact_screen_title: Record Editor - Note Pin
...
SCREEN_SPEC_3:
- exact_screen_title: Insights - Note Pin
